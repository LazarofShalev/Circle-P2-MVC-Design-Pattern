...
public class CircleController2 extends GridPane implements CircleEvents, EventHandler<ActionEvent> {
	...
	public CircleController2(SimpleIntegerProperty circleCounter) {
	...
	public void setModel(CircleModel2 circleModel2) {
		this.model = circleModel2;
	}
